 ...
 * Cette classe initialise le service et effectue des opérations de base pour démontrer les fonctionnalités.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Tentative de récupération de la description d'une clé non existante.
